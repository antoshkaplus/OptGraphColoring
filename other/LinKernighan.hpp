...
////
//
//#ifndef __TravelingSalesman__LinKernighan__
//#define __TravelingSalesman__LinKernighan__
//
//#include <iostream>
//
////#include "support.h"
...
//  double minGain;
//  
//  LinKernighan(const vector<int>& cities, const vector<Point>& ps, 
...
//    } while (didTourChanged); 
//    return tour.cities;
//  }
//};
//
//
//#endif /* defined(__TravelingSalesman__LinKernighan__) */
